        ...
        <div className={styles.aboutSection}>
          <div className="section container">
            ...
            <p className={styles.aboutMeText}>
              ...
              myself drawn to web programming - particularly to the creativity,
              the methodical thinking, and the satisfaction of problem solving
              that comes along with it. The aspects that interested me in
              finance - finding patterns, keeping things organized, and focusing
              on details - are the same qualities that drew me to coding and
              help me in writing clear, organized code.
            </p>
            <p className={styles.aboutMeText}>
